-- Fix return type error by dropping existing function first
-- This addresses the error: cannot change return type of existing function

-- Drop the existing function first
DROP FUNCTION IF EXISTS public.sz_checkin(uuid, integer, uuid[], text, text);

-- Now create the simplified function with the correct return type
