-- Simple Streak Replication Script
-- Extracts users and habits from source streak and replicates to target streak

-- Function to replicate users and their habits
CREATE OR REPLACE FUNCTION replicate_streak_data(
...
-- Clean up
DROP FUNCTION replicate_streak_data(UUID, UUID);
