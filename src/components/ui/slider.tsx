...
const Slider = React.forwardRef<
  ...
  SliderProps
>(({ className, trackClassName, rangeClassName, thumbClassName, thumbChildren, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn("relative flex w-full touch-none select-none items-center", className)}
    {...props}
  >
    <SliderPrimitive.Track className={cn("relative h-2 w-full grow overflow-hidden rounded-full bg-primary", trackClassName)}>
