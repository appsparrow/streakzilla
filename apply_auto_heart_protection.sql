-- Apply Automatic Heart Protection System
-- Run this script in your Supabase SQL Editor to enable automatic heart usage
...
-- Drop the existing checkin function first (due to return type change)
