-- =====================================================
-- ADD IS_CORE COLUMN AND UPDATE EXISTING STREAKS
-- =====================================================
-- This script adds the missing is_core column to sz_user_habits
-- and then updates all existing streaks to match template definitions
-- =====================================================

-- =====================================================
-- STEP 1: ADD MISSING COLUMNS TO SZ_USER_HABITS
-- =====================================================
...
-- =====================================================
-- STEP 2: FIX CHECK-IN FUNCTION (AMBIGUOUS COLUMN ERROR)
-- =====================================================
...
-- =====================================================
-- STEP 3: UPDATE EXISTING STREAKS
-- =====================================================
