-- =====================================================
-- UPDATE EXISTING STREAKS - FINAL VERSION
-- =====================================================
-- This script updates existing streaks to match template definitions
-- after the missing columns have been added to sz_user_habits
-- =====================================================
...
-- =====================================================
-- STEP 2: UPDATE EXISTING STREAKS
-- =====================================================
...
SELECT 
    ...
    'Check-in function fixed (ambiguous column error resolved)' as step1,
    'All existing streaks updated to match template definitions' as step2,
    'Core habits properly marked and points calculated correctly' as step3,
